...
updateServiceList.onchange = function () {
  ...
  var updateselectedServiceWeightUnit = this.options[this.selectedIndex].getAttribute(
    "data-weight-unit"
  );
  var updateselectedServiceWeightRange = this.options[this.selectedIndex].getAttribute(
    "data-weight-range"
  );
