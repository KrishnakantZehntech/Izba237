...
var contractURl = `https://cleanstation.backendless.app/api/services/Brand/BrandContract?User_id=${objctID}`
...
// Create a closure to store the fetched data
const fetchZoneValue = (function () {
    let zoneData = null;
    ...
    return function () {
      ...
      if (!isNaN(weightRange) && !isNaN(zoneRange) && selectedServiceWeightUnit) {
        ...
        if (zoneData) {
          // Data has already been fetched, use it
          const matchingZone = zoneData.find(entry =>
