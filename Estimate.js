...
function weightZoneRange(ServiceID) {
    ...
    const weightRangeLabel = document.getElementById("weightRangeLabel");
            ...
            console.log("Zone Input:", zoneInput);
            ...
            if (!isNaN(weightInput) && !isNaN(zoneInput) && selectedServiceWeightUnit) {
                ...
                if (matchingZone) {
                    console.log("matching value:", matchingZone);
                const zoneValue = matchingZone[`Zone_${zoneInput}`];
                dataResult.textContent = `Zone Value: ${zoneValue}`;
                } else {
...
$("#ESTcreateunitbutton").click(function () {
    ...
    //       // result = matchingZone;
    //       return (
    //         zone[weightField] === weightInput &&
    //         zone[`Zone_${zoneInput}`] !== undefined
    //       );
    //     });
