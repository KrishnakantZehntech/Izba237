...
// var updateRateCardList = document.getElementById("updateRateCardList");
// var updateServiceList = document.getElementById("updateServiceList");
...
//   .then((response) => response.json())
//   .then((responseData) => {
//     updateContractData = responseData; // Store the contract data
//     populateContractDropdown(updateContractData);
//   })
//   .catch((error) => {
//     console.error("Error fetching contract data:", error);
//     populateRateCardDropdown([]);
//   });

// function populateContractDropdown(data) {
//   for (var entry of data) {
//     updateCountyList.options[updateCountyList.options.length] = new Option(
//       entry.Contract_name,
//       entry.objectId
//     );
//   }
...
//   var selectedServiceId = this.value;
//   var selectedServiceName = this.options[this.selectedIndex].text;
//   var selectedServiceWeightUnit = this.options[this.selectedIndex].getAttribute(
//     "data-weight-unit"
//   );
//   var selectedServiceWeightRange = this.options[this.selectedIndex].getAttribute(
//     "data-weight-range"
//   );
//   localStorage.setItem("selectedServiceId", selectedServiceId);
//   localStorage.setItem("selectedServiceName", selectedServiceName);
...
// function populateServiceDropdown(selectedRateCardId) {
...
//       var selectedRateCard = rateCardData.find(
...
//           entry.objectId
//         );
//         updateServiceList.options[updateServiceList.options.length - 1].setAttribute(
//           "data-weight-unit",
//           serviceWeightUnit
//         );
//         updateServiceList.options[updateServiceList.options.length - 1].setAttribute(
...
$("#Home").click(function () {
    $("#Detail, #Create, #Update, #RCDetail, #RCCreate, #RCUpdate, #CreateService, #CreateFC, #ProductDetail, #UploadProduct, #estimate, #Detail, #Create, #Update").hide();
