...
$(document).ready(function () {
  $("#CreateContractRatesBtn").click(function () {
    ...
    var value = centers.selectedIndex;
    var selected_center = centers.options[value].text;
    ...
    if (cName === "" || centers === "" || startDate === "" || endDate === "") {
      ...
      $("#fcNameText").text(selected_center);
      // set time diff
...
async function sendProductData(requestData) {
  try {
    ...
    if (response.ok) {
      ...
      document.getElementById("product-dropdown").value = data.objectId;
