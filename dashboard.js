...
function editContract(contractId) {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      const centerName = data.Fulfillment_Center.Center_Name;
      const objectId = data.Fulfillment_Center.objectId;
      // Destroy the current Select2 instance and recreate it with the new value
      // $('#editcemters').select2('destroy');
      $('#editcemters').empty().append(new Option(centerName, objectId, true, true)).select2();
