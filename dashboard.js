...
async function populateDropdown(objectId) {
  ...
  if (productData.length > 0) {
    // Sort productData by upload time (assuming there's a timestamp field)
    productData.sort((a, b) => new Date(b.uploadTime) - new Date(a.uploadTime));
