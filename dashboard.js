...
$(document).ready(function () {
  ...
  // pick and pack 
  $("#Baseorderfee").on("input", function () {
    ContractRateError();
  });
  $("#additionalPickfee").on("input", function () {
    ContractRateError();
  });
  $("#BaseReturnFee").on("input", function () {
    ContractRateError();
  });
  $("#PerKitFee").on("input", function () {
    ContractRateError();
  });

  // storage 
  $("#PalletFee").on("input", function () {
    ContractRateError();
  });
  $("#SelfFee").on("input", function () {
    ContractRateError();
  });
  $("#BinFee").on("input", function () {
    ContractRateError();
  });
 
  // receiving 
  $("#palletReciiptRate").on("input", function () {
    ContractRateError();
  });
  $("#CaseRecipRate").on("input", function () {
    ContractRateError();
  });
  
  // labor 
  $("#WHlabor").on("input", function () {
    ContractRateError();
  });
  $("#laborOtrate").on("input", function () {
    ContractRateError();
  });
  $("#laborItrate").on("input", function () {
    ContractRateError();
  });
