...
$(document).ready(function () {
  ...
  hideErrorOfInput("#Baseorderfee", "#pickPackError");
  hideErrorOfInput("#additionalPickfee", "#pickPackError");
  hideErrorOfInput("#BaseReturnFee", "#pickPackError");
  hideErrorOfInput("#PerKitFee", "#pickPackError");
