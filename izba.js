...
// Error handling for Brand Name, Start date, End date, and Fulfillment Center 
...
// End here error handling for brand 


// Global variable for store value of Brand name, start & end date and Fulfillment center name 
var Brandname;
var StartDate;
var EndDate;
var FulfillmentCenterId;
var BrandData;
var FulfillmentContractData;
var EstimateData;

// Go to Receiving and validation 
$("#goToReciving").click(function () {
  ...
  if (brandNameInput !== "" && startDate !== "" && endDate !== "" && centers !== "") {
    ...
    //     console.log("Retrieved brandId:", brandId);
    //   })
...
//Go to Estimate and save Fullfillment contract data with relation
$(document).ready(function () {
  ...
  $("#MonthlyManagementFeeInput, #MonthlyMinimumFeeInput").on("input", function () {
      if ($("#MonthlyManagementFeeInput").val() && $("#MonthlyMinimumFeeInput").val()) {
        errorMisc1.style.display = "none";
      } else {
  ...
  $("#goToEstimates").click(function () {
    ...
    const selectedCenterId = FulfillmentCenterId;
    if ((MonthlyManagementFeeInput !== "" && MonthlyMinimumFeeInput !== "") && (StandardHourlyLaborInput !== "" || OTHourlyLaborInput !== "" || ITHourlyLaborInput !== "" )) {
      
      // Api logic for create Guest brand 
      let dataToSend = {
      ...
      //Api Logic for create fulfillment contract post data
      let postEstimate = {
        Fulfillment_Center: {
      ...
      fetch(
        ...
        .then((response) => response.json())
        .then((data) => {
          FulfillmentContractData = data;
          // console.log("Paras API", data);
          fcobjId = data.objectId;
          // console.log("FcobjID", fcobjId);
 ...
 //Back to Misc
  ...
  // Show Hide using Estimate Button and set Quantity in Estimate Table
  $(document).ready(function () {
    checkInputs();
    ...
    $("#gotoEstimateDetail").click(function () {
      ...
      // Create Estimate after fil ranges inputs
      ...
      fetch(
        ...
        .then((data) => {
          ...
          // Create the donut chart using the provided function
          ...
          const startDatee = new Date(FulfillmentContractData.Start_Date);
          const endDatee = new Date(FulfillmentContractData.End_Date);
          ...
          document.getElementById("managementFeeText").innerHTML = "$" + FulfillmentContractData.Management_Fee;
          document.getElementById("minimunFeeText").innerHTML = "$" + FulfillmentContractData.Minimum_Fee;
          document.getElementById("standardHourlyLaborText").innerHTML = "$" + FulfillmentContractData.Labor_Warehouse_Rate;
          document.getElementById("OTHourlytext").innerHTML = "$" + FulfillmentContractData.Labor_OT_Rate;
          document.getElementById("ITHourlyText").innerHTML = "$" + FulfillmentContractData.Labor_IT_Rate;
          document.getElementById("baseOrderFeeText").innerHTML = "$" + FulfillmentContractData.Base_Per_Order_Fee;
          document.getElementById("additionalPickFeeText").innerHTML = "$" + FulfillmentContractData.Additional_Pick_Fee;
          document.getElementById("baseReturnFeeText").innerHTML = "$" + FulfillmentContractData.Base_Per_Return_Fee;
          document.getElementById("perKitFeeText").innerHTML = "$" + FulfillmentContractData.Additional_Pick_Kit;
          document.getElementById("storagePerBinText").innerHTML = "$" + FulfillmentContractData.Storage_Per_Bin;
          document.getElementById("storagePerShelftext").innerHTML = "$" + FulfillmentContractData.Storage_Per_Shelf;
          document.getElementById("storagePerPalletText").innerHTML = "$" + FulfillmentContractData.Storage_Per_Pallet;
          document.getElementById("receiptPerPalletText").innerHTML = "$" + FulfillmentContractData.Receipt_Per_Pallet_Fee;
          document.getElementById("receiptPerCaseText").innerHTML = "$" + FulfillmentContractData.Receipt_Per_Case_Fee;
        });
    });
  });

  // Check input value and disable the ranges according input value 
...
//   function setEstimateData(FulfillmentContractData) {
//     const startDatee = new Date(FulfillmentContractData.Start_Date);
//     const endDatee = new Date(FulfillmentContractData.End_Date);
//     const timeDifference = endDatee.getTime() - startDatee.getTime();
//     const daysDifference = timeDifference / (1000 * 3600 * 24);
...
//     document.getElementById("receiptPerCaseText").innerHTML = "$" + FulfillmentContractData.Receipt_Per_Case_Fee;
// };
   // Show create fulfillment center section
  $(document).ready(function () {
  ...
  // Hide create fulfillment center section
  $(document).ready(function () {
  ...
  function showAllErrors() {
    ...
    if (fcaddress === "") {
      showError(
        "#fcaddressError",
        "Fulfillment center address should not be blank"
      );
    } else {
    ...
    if (fcState === "") {
      showError(
        "#fcStateError",
        "Fulfillment center state should not be blank"
      );
    } else {
    ...
    if (fcZipCode === "") {
      showError(
        "#fcZipCodeError",
        "Fulfillment center zip code should not be blank"
      );
    } else {
    ...
    if (fcCounter === "") {
      showError(
        "#fcCounterError",
        "Fulfillment center country should not be blank"
      );
    } else {
  ...
  $("#addFccenter").click(function () {
    ...
    if (
      ...
      setupInputField(
        "#fcName",
        "#fcNameError",
        "Fulfillment center name should not be blank"
      );
      setupInputField(
        "#fcUrl",
        "#fcUrlError",
        "Fulfillment center URL should not be blank"
      );
      setupInputField(
        "#fcaddress",
        "#fcaddressError",
      ...
      setupInputField(
        "#fcCity",
        "#fcCityError",
        "Fulfillment center city should not be blank"
      );
      setupInputField(
        "#fcState",
        "#fcStateError",
      ...
      setupInputField(
        "#fcCounter",
        "#fcCounterError",
        "Fulfillment center counter should not be blank"
      );
    }
      ...
      .then((data) => {
        ...
        fetch(
          ...
          res.json().then((data) => {
            ...
            // Receiving
            document.getElementById("updatePalletReceived").value =
              data.ReceiptPallet;
            document.getElementById("UpdateCaseReceived").value =
              data.ReceiptCase;
            // Labour
  ...
  const updatedData = {
    ...
    Management_Fee:
      document.getElementById("updateManagementFee").value === ""
        ? 0
        : parseFloat(document.getElementById("updateManagementFee").value),
    Minimum_Fee:
      document.getElementById("updateMInimumFee").value === ""
        ? 0
