...
$(document).ready(function () {
 ...
 $("#AddFulfillmentButton").click(function () {
  ...
  $("#closeFulfillmentCenterPopup").click(function () {
    ...
    function handleInputWithValidation(inputId, errorId, errorMessage) {
      const input = $(inputId);
      const error = $(errorId);
      ...
      input.on("input", function () {
        if (input.val()) {
          ...
          error.text(errorMessage); // Set the custom error message
        }
      });
    }
    
    const fields = [
      { inputId: "#fcName", errorId: "#fcNameError", errorMessage: "Name should not be empty" },
      { inputId: "#fcUrl", errorId: "#fcUrlError", errorMessage: "URL should not be empty" },
      { inputId: "#fcaddress", errorId: "#fcaddressError", errorMessage: "Address should not be empty" },
    ...
    function showAllErrors() {
      fields.forEach(field => {
        ...
        if (input.val() === "") {
          showError(field.errorId, field.errorMessage);
        } else {
    ...
    $("#addFccenter").click(function () {
      ...
      fields.forEach(field => {
        ...
        handleInputWithValidation(field.inputId, field.errorId, field.errorMessage);
      });
