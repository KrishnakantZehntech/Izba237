...
$(document).ready(function () {
  ...
  const errorStorage = document.getElementById("errorStorage");
  $("#storagePerPalletInput, #storagePerShelfInput , #storagePerBin").on(
    "input",
    function () {
      if ($(this).val()) {
        errorStorage.style.display = "none";
...
$(document).ready(function () {
  ...
  const errorPicking = document.getElementById("errorPicking");
  $(
    "#BaseFeePerOrderInput, #AdditionalPickFeeInput , #BaseReturnFeeInput,#BaseReturnFeeInput"
  ).on("input", function () {
    if ($(this).val()) {
      errorPicking.style.display = "none";
    } else {
...
$(document).ready(function () {
  ...
  $("#MonthlyManagementFeeInput, #MonthlyMinimumFeeInput, #StandardHourlyLaborInput, #OTHourlyLaborInput, #ITHourlyLaborInput").on("input", function () {
    const managementFeeInput = $("#MonthlyManagementFeeInput").val();
    const minimumFeeInput = $("#MonthlyMinimumFeeInput").val();
    const standardHourlyLaborInput = $("#StandardHourlyLaborInput").val();
    const otHourlyLaborInput = $("#OTHourlyLaborInput").val();
    const itHourlyLaborInput = $("#ITHourlyLaborInput").val();
  // $("#MonthlyManagementFeeInput, #MonthlyMinimumFeeInput").on(
  //   "input",
  //   function () {
  //     if ($("#MonthlyManagementFeeInput").val() && $("#MonthlyMinimumFeeInput").val() && ($("#StandardHourlyLaborInput").val() || $("#OTHourlyLaborInput").val() || $("#ITHourlyLaborInput").val() ) ) {
  //       errorMisc1.style.display = "none";
  //       errorMisc.style.display = "none";
  //     } else {
  ...
  //     }
      ...
      // if ((managementFeeInput && minimumFeeInput)(standardHourlyLaborInput || otHourlyLaborInput || itHourlyLaborInput)) {
      //   // errorMisc1.style.display = "none"; // Hide the management error
      //   // errorMisc.style.display = "none"; // Hide the minimum fee error

      //   MinimumFeeError.style.display = "none"; // Show the management error
      //   ManagementFeeError.style.display = "none";
      //   errorMisc.style.display = "none"; // Show the minimum fee error

      // } else if (managementFeeInput && minimumFeeInput) {
      //   MinimumFeeError.style.display = "none"; // Show the management error
      //   ManagementFeeError.style.display = "none";
      //   errorMisc.style.display = "block"; // Show the minimum fee error
      // } else if (standardHourlyLaborInput || otHourlyLaborInput || itHourlyLaborInput) {
      //   // errorMisc1.style.display = "block"; // Show the management error
      //   errorMisc.style.display = "none"; // Hide the minimum fee error
      // } else {
      //   MinimumFeeError.style.display = "block"; // Show the management error
  ...
  // $("#StandardHourlyLaborInput, #OTHourlyLaborInput, #ITHourlyLaborInput").on(
  //   "input",
  //   function () {
  //     if ($(this).val()) {
  //       errorMisc.style.display = "none";
...
//     if (
//       (MonthlyManagementFeeInput !== "" && MonthlyMinimumFeeInput !== "") && ( StandardHourlyLaborInput !== "" || OTHourlyLaborInput !== "" || ITHourlyLaborInput !== "") ) {
...
//         console.log("Create time BrandId:", BrandId);
//       })
//       .catch((error) => console.error("Error:", error));
      
//         //Api Logic for post Fulfillment contract data
//       let postEstimate = {
//         Fulfillment_Center: {
...
//         .then((response) => response.json())
//         .then((data) => {
//           console.log("Create_Fulfillment_Contract API Data", data);
//           fcobjId = data.objectId;
//           console.log("Fulfillment_Contract objectId", fcobjId);
  ...
  if (
      ...
      fetch("https://cleanstation.backendless.app/api/data/Brand", {
          ...
          .then((data) => {
              ...
              // Once BrandId is obtained, proceed with the postEstimate data
              postEstimate.Brand_id.objectId = BrandId;

              // Now post the postEstimate data
              fetch("https://cleanstation.backendless.app/api/services/Estimate/Create_Fulfillment_Contract", {
                  method: "POST",
                  body: JSON.stringify(postEstimate),
                  headers: {
                      "Content-type": "application/json; charset=UTF-8",
