...
$(document).ready(function () {
 ...
 $("#AddFulfillmentButton").click(function () {
  ...
  //     if (fcName === "") {
  //       showError("#fcNameError");
  //     } else {
  //       hideError("#fcNameError");
  //     }
  
  //     if (fcUrl === "") {
  //       showError("#fcUrlError");
  //     } else {
  //       hideError("#fcUrlError");
  //     }
  
  //     if (fcaddress === "") {
  //       showError("#fcaddressError");
  //     } else {
  //       hideError("#fcaddressError");
  //     }
  
  //     if (fcCity === "") {
  //       showError("#fcCityError");
  //     } else {
  //       hideError("#fcCityError");
  //     }
  
  //     if (fcState === "") {
  //       showError( "#fcStateError" );
  //     } else {
  //       hideError("#fcStateError");
  //     }
  
  //     if (fcZipCode === "") {
  //       showError( "#fcZipCodeError");
  //     } else {
  //       hideError("#fcZipCodeError");
  //     }
  
  //     if (fcCounter === "") {
  //       showError("#fcCounterError");
  //     } else {
  //       hideError("#fcCounterError");
  //     }
  //   }
...
// Function to hide an error message for a field
function hideError(errorId) {
  $(errorId).text(""); // Clear the error message
  $(errorId).hide();
}

// Add an input event listener for each required field
$("#fcName, #fcUrl, #fcaddress, #fcCity, #fcState, #fcZipCode").on("input", function () {
  const fieldId = "#" + this.id;
  const errorId = "#" + this.id + "Error";

  if ($(fieldId).val().trim() === "") {
    showError(fieldId, errorId, `${this.id} is not be empty`);
  } else {
    hideError(errorId);
  }
});
